...
public class EmailService {
        ...
        try {
            ...
            String content = String.format(
                    "<!DOCTYPE html>" +
                            ...
                            "h2 { color: #4CAF50; font-size: 28px; margin-bottom: 15px; }" +
                            ".match-card { background: linear-gradient(135deg, #667eea 0%%, #764ba2 100%%); padding: 30px; border-radius: 20px; margin: 30px 0; text-align: center; color: white; box-shadow: 0 10px 30px rgba(102, 126, 234, 0.3); }" +
                            ".match-card h3 { font-size: 24px; margin-bottom: 15px; color: white; }" +
                            ".match-percentage { font-size: 64px; font-weight: bold; margin: 20px 0; background: rgba(255,255,255,0.2); display: inline-block; padding: 20px 40px; border-radius: 60px; }" +
                            ".btn { display: inline-block; background: #4CAF50; color: white; padding: 14px 35px; text-decoration: none; border-radius: 50px; margin: 20px 0; font-weight: 600; font-size: 16px; transition: all 0.3s ease; }" +
            ...
            System.err.println("❌ Failed to send match notification to: " + to);
            System.err.println("Error: " + e.getMessage());
        }
    }
        ...
        try {
            ...
            String content = String.format(
                    "<!DOCTYPE html>" +
                            ...
                            ".header h1 { color: white; margin: 0; font-size: 28px; }" +
                            ".content { padding: 40px 30px; }" +
                            "h2 { color: #667eea; font-size: 28px; margin-bottom: 20px; }" +
                            ".feature-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 30px 0; }" +
                            ".feature-card { background: #f8f9ff; padding: 20px; border-radius: 12px; text-align: center; }" +
                            ".feature-icon { font-size: 32px; margin-bottom: 10px; }" +
                            ".feature-card h3 { font-size: 16px; margin: 10px 0; color: #667eea; }" +
                            ".feature-card p { font-size: 13px; color: #6c757d; margin: 0; }" +
                            ".btn { display: inline-block; background: linear-gradient(135deg, #667eea 0%%, #764ba2 100%%); color: white; padding: 14px 35px; text-decoration: none; border-radius: 50px; margin: 25px 0; font-weight: 600; font-size: 16px; transition: all 0.3s ease; }" +
                            ...
                            "<div class='feature-card'><div class='feature-icon'>📄</div><h3>AI Resume Analysis</h3><p>Get instant insights and improvement suggestions</p></div>" +
                            "<div class='feature-card'><div class='feature-icon'>🎯</div><h3>Smart Matching</h3><p>Personalized job recommendations</p></div>" +
                            "<div class='feature-card'><div class='feature-icon'>📊</div><h3>Track Applications</h3><p>Monitor your progress in real-time</p></div>" +
                            "<div class='feature-card'><div class='feature-icon'>💡</div><h3>Skill Insights</h3><p>Identify skill gaps and growth opportunities</p></div>" +
                            "</div>" +
                            "<div style='text-align: center;'>" +
    ...
    public void sendApplicationConfirmation(String to, String candidateName, String jobTitle, String company, int matchPercentage) {
        try {
            ...
            System.err.println("❌ Failed to send application confirmation to: " + to);
            System.err.println("Error: " + e.getMessage());
        }
    }
    ...
    public void sendNewApplicationNotification(String to, String recruiterName, String jobTitle, String candidateName, int matchPercentage) {
        try {
            ...
            System.err.println("❌ Failed to send new application notification to: " + to);
            System.err.println("Error: " + e.getMessage());
        }
    }
    ...
    public void sendApplicationStatusUpdate(String to, String candidateName, String jobTitle, String company, String status, String notes) {
        try {
            ...
            System.err.println("❌ Failed to send status update to: " + to);
            System.err.println("Error: " + e.getMessage());
        }
    }
